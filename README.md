...
| [`zapi_eideswtdocstep/`](zapi_eideswtdocstep/README.md) | CDS View `ZC_EIDESWTDOCSTEP`: publica la tabla `EIDESWTDOCSTEP` como API OData para consumo desde NAPAI — **propuesta técnica, sin DF de origen, pendiente de validar** |
