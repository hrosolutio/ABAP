...
| [`zfi_r_devoluciones_crea/`](zfi_r_devoluciones_crea/README.md) | Report `ZFI_R_DEVOLUCIONES_CREA`: creación del lote de devoluciones en FI-CA a partir del `_DEV`, proceso `CDI_11` (2/3) — reescrito sobre la API real de `FP09` (`FKK_RLS_*`), **probado con éxito en Integración**; pendiente de probar el programa completo en SE38 |
