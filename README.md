...
| [`zfi_fm_payment_lot_clarify2/`](zfi_fm_payment_lot_clarify2/README.md) | RFC `ZFI_FM_PAYMENT_LOT_CLARIFY2`: clarificación de transferencias pendientes en SAP (FI-CA) — primera versión, **pendiente de prueba end-to-end real** |
