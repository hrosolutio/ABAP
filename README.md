...
| [`zeideswtdocstep_srv/`](zeideswtdocstep_srv/README.md) | Servicio SEGW `ZEIDESWTDOCSTEP_SRV`: publica la tabla `EIDESWTDOCSTEP` como API OData para consumo desde NAPAI — **probado en desarrollo, sin DF de origen, pendiente de autenticación/transporte/delta** |
