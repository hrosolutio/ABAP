...
| [`zfi_r_devoluciones2/`](zfi_r_devoluciones2/README.md) | Report `ZFI_R_DEVOLUCIONES2`: cierre y contabilización del lote de devolución de extornos, proceso `CDI_11` (3/3) — reescrito sobre `FKK_RLS_CLOSE`/`FKK_RLS_POST_LOT` (no `RFKKKA00`), decide por `DFKKRK-STARS`; **pendiente de probar** (falta traza real en `ZFI_T_FILE_LOG`, solo la deja el modo Server de RU_02) |
