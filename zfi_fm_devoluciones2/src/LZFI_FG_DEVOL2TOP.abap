...
* IT_KEYR1 (lotes de entrada) usa un tipo de tabla DDIC (creado en
* SE11, ver README) - el Function Builder no admite un TYPES de
* programa como tipo de referencia de un parámetro de import/export,
* tiene que ser un objeto DDIC real (mismo patrón ya usado en
* ZFI_T_XBLNR de ZFI_FM_PAYMENT_LOT_CLARIFY2):
